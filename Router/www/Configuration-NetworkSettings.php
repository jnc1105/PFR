      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="application/x-www-form-urlencoded" id="dynamic">
        <table width="100%" border="0">
          <tr>
            ...
            <td><input name="dhcpclientid" type="text" autofocus id="dhcpclientid" form="dynamic" placeholder="PhotoFrame" pattern="^[a-zA-Z0-9_-]*$" maxlength="17" <?php if(!empty($configurationsettings['dhcpclientid'])) {echo "value=" . $configurationsettings['dhcpclientid'];}?>></td>
          </tr>
          <tr>
