...
function ReturnFinish(date) {
	document.getElementById('status').innerHTML = 'Click below link to download your back-up.<br><a href="temp/PhotoFrameRouterBackup-'+date+'.tar" target="_blank">PhotoFrameBackup-'+date+'.tar</a>';
