...
<div class="container"> 
  ...
  <header>
    <div id="titlebar">
      <span id="title"><center><h1>Photo Frame Router</h1></center></span>
    </div>
  </header>
<p>&nbsp;</p>
    ...
    <nav>
      ...
      <ul>
        ...
        <li class='has-sub' id="Maintenance"><a href='#'><span>Maintenance</span></a>
            <ul id="MaintenanceUl">
              <li><a href='Maintenance-ChangePassword.php'><span>Reset Passworsd</span></a></li>
    ...
    <div id="ContentTitle"><span>OpenVPN Server Certificate Authority</span></div>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="application/x-www-form-urlencoded" id="frm_ca_init">
        <fieldset><legend>Initialize Certificate Authority</legend>
          <table width="100%" border="0">
            <tr>
              <td colspan="2" align="left">Since OpenVPN works with certificates to authenticate it's clients, you first need to <br />
            	initialize a Certificate Authority to establish a Public Key Infrastructure. Once you have<br />
				initialised your Certificate Authority you will be able to generate certificates for clients who <br />
          		will be dialing into this VPN server.  Raspberry WAP uses OpenVPN as its VPN server.<br /></td>          
            </tr>
            <tr>
              <td colspan="2" align="left">Beware when choosing the Cryptographic Strength for this Certificate Authority, the higher <br />
              you choose, the slower this will run on the router.</td>
              </tr>
            <tr>
              <td align="right">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td><input name="txtcountry" type="text" required id="txtcountry" form="frm_ca_init" placeholder="US" pattern="^[a-zA-Z]*$" size="2" maxlength="2" <?php if(!empty($configurationsettings['certcountry'])) {echo 'value="' . $configurationsettings['certcountry'] . '"';}?> pattern="^[a-zA-Z0-9_-]*$"></td>
            </tr>
            <tr>
