  ...
  ?>
    ...
    <div id="ContentArticle" <?php if(strcmp($configurationsettings['operationmode'],'Router') == 0) {echo 'style="display: none"';}?>>
      <table width="100%" border="0">
        <tr>
          <td align="center">
              <p>The Photo Frame Router is currently operating in Access Point modus.<br />
              The Captive Portal functionality is only available when the Photo Frame Router is operating in Router modus.<br />
              To switch the Photo Frame to Router mode, select Configuration - Operation mode, and switch to Router mode.
              </p>
          </td>
        </tr>
    </table>
...
<p>&nbsp;</p>     
<p>&nbsp;</p>     
<center><p style="font-size:75%;">Copyright Disguised Technologies ©<script>document.write(new Date().getFullYear());</script> All rights reserved </p></center>
  </footer>
